...
export function Footer() {
  return (
    <footer className="border-t border-[rgba(76,217,100,0.08)] bg-[#0B1A10]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="col-span-2 md:col-span-1">
            <TruoyyLogo className="h-13 w-auto mb-4" />
              ...
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="text-sm text-[rgba(255,255,255,0.4)] hover:text-[#E5E7EB] transition-colors"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="mt-10 pt-6 border-t border-[rgba(255,255,255,0.06)] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[rgba(255,255,255,0.3)]">
            &copy; {new Date().getFullYear()} Trueyy. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            <a href="#" className="text-[rgba(255,255,255,0.3)] hover:text-[#E5E7EB] transition-colors">
